...
contract MarketFactory {
    ...
    int256 public constant MIN_INITIAL_ANCHOR = PMath.IONE;

    // PT => scalarRoot => initialAnchor => lnFeeRateRoot => market
    mapping(address => mapping(int256 => mapping(int256 => mapping(uint256 => address))))
        private s_markets;
    address[] private s_allMarkets;

    constructor(address _ptYtFactory) {
