...
abstract contract SYBase is ERC20, ISY {
    ...
    function _deposit(uint256 amounTokenToDeposit) internal view virtual returns (uint256 amountSharesOut);

    function _redeem(uint256 amountSharesToRedeeem) internal view virtual returns (uint256 amountTokenOut);
